...
src/fuzzmax.o : $(COMM_HDR) src/fuzzmax.c include/fuzzmax.h
	$(CC) $(CFLAGS) $(CFLAGS_FLTO) -c src/fuzzmax.c -o src/fuzzmax.o

afl-fuzz: $(COMM_HDR) include/afl-fuzz.h $(AFL_FUZZ_FILES) src/afl-common.o src/afl-sharedmem.o src/afl-forkserver.o src/afl-performance.o src/fuzzmax.o | test_x86
	$(CC) $(CFLAGS) $(COMPILE_STATIC) $(CFLAGS_FLTO) $(AFL_FUZZ_FILES) src/afl-common.o src/afl-sharedmem.o src/afl-forkserver.o src/afl-performance.o src/fuzzmax.o -o $@ $(PYFLAGS) $(LDFLAGS) -lm
